...
const MbSearchBar = () => {
    ...
    return (
        <div className='pt-2 mx-2'>
            <form onSubmit={handleSubmitSearch} className="w-full sm:w-[630px] m-auto shadow-md h-[50px] rounded-md border-gray-600 dark:bg-[#191919] bg-white  flex items-center flex-1">
