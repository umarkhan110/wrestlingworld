...
export default function MBSideBars({setSidebarOpen}) {
    ...
    return (
        <div className="font_exo no-scrollbar h-screen z-30 fixed top-0 left-0 px-5 py-4 w-[250px] bg-white dark:bg-[#191919]">
            ...
            <ul className="pt-10 h-[100%] overflow-y-scroll overflow-x-hidden no-scrollbar">
                {
